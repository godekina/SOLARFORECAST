...
st.set_page_config(page_title="SOLAR FORECAST",
...
if page == "Application":
  ...
  st.write(
    'This app enables you to generate time series forecast for Solar Energy without any dependencies.'
  )
  st.markdown(
    """The forecasting library used is **[GRU](https://en.wikipedia.org/wiki/Gru)**."""
  )
  ...
  with st.container():
    ...
    with st.expander("Growth model"):
      st.write('Default is the linear growth model.')
...
if page == "About":
  st.header("About")
  st.markdown(
    "Official documentation of **[GATED RECCURENT UNIT](https://en.wikipedia.org/wiki/Gru)**"
  )
  st.markdown(
  ...
  st.write("")
  st.write("Author:")
  st.markdown(""" **YUSUF OBAFEMI**""")
  

  st.write("Created THE YEAR 2025")
